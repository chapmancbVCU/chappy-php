...
<div class="main">
    ...
    <div class="mb-5 mt-3 w-75 bg-light mx-auto border rounded p-4">
        ...
        <figure class="d-flex flex-column justify-content-center align-items-center">
            <img class="img-fluid" src="<?=PROOT?>public/images/userGuide/user_profile.png" alt="Default Profile View">
    ...
    <div class="mb-5 mt-3 w-75 bg-light mx-auto border rounded p-4">
        ...
        <figure class="d-flex flex-column justify-content-center align-items-center">
            <img class="img-fluid" src="<?=PROOT?>public/images/userGuide/edit_profile.png" alt="Edit Profile">
    ...
    <div class="mb-5 mt-3 w-75 bg-light mx-auto border rounded p-4">
        ...
        <figure class="d-flex flex-column justify-content-center align-items-center">
            <img class="img-fluid" src="<?=PROOT?>public/images/userGuide/profile_image.png" alt="Edit Profile Image Page">
    ...
    <div class="mb-5 mt-3 w-75 bg-light mx-auto border rounded p-4">
        ...
        <figure class="d-flex flex-column justify-content-center align-items-center">
            <img class="img-fluid" src="<?=PROOT?>public/images/userGuide/change_password.png" alt="Update Password Page">
