<?php $this->setSiteTitle("NumberCharValidator - Custom MVC Framework Docs"); ?>
<?php $this->start('body'); ?>
...
<div class="main">
    ...
    <h1 class="text-center">NumberValidator Class</h1>
    <div class="row align-items-center justify-content-center my-3">
        <p class="text-center w-75">Child class class that supports ability to check if field contains a numeric character in the field.</p>
    </div>
    ...
    <table class="table table-striped table-condensed table-bordered table-hover w-75 mx-auto table-sm mb-5">
        ...
        <tr>
            <td colspan="2">Implements the abstract function of the same name from the parent class.  Enforces requirement where a field must contain at least one numeric character.</td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td>True if field contains at least one upper case character.</td>
        </tr>
    </table>
