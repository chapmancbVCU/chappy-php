...
<div class="main">
    ...
    <table class="table table-striped table-condensed table-bordered table-hover w-75 mx-auto mb-5 table-sm">
        ...
        <tr>
            <td>
                <a href="<?=APP_DOMAIN?>documentation/core" class="text-primary">Core</a>
            </td>
        ...
        <tr>
            <td><a href="<?=APP_DOMAIN?>documentation/models" class="text-primary">Models</a></td>
            <td>Documentation for models responsible for the application's logic and database operations.</td>
        </tr>
        <tr>
            <td><a href="<?=APP_DOMAIN?>documentation/validators" class="text-primary">Validators</a></td>
