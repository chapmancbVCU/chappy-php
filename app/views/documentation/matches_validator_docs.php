<?php $this->setSiteTitle("Matches Validator - Custom MVC Framework Docs"); ?>
<?php $this->start('body'); ?>
...
<div class="main">
    ...
    <h1 class="text-center">MatchesValidator Class</h1>
    <div class="row align-items-center justify-content-center my-3">
        <p class="text-center w-75">Child class that performs validation for two fields that are required to have the same value.</p>
    </div>
    ...
    <table class="table table-striped table-condensed table-bordered table-hover w-75 mx-auto mb-5">
        ...
        <tr>
            ...
            <td>True if values match.  Otherwise, we return false.</td>
        </tr>
    </table>
