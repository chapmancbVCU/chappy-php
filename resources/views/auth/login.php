...
<div class="row align-items-center justify-content-center">
    <div class="col-md-6 bg-light p-3">
        ...
        <form class="form" action="<?=APP_DOMAIN?>auth/login" method="post">
            ...
            <div class="d-flex justify-content-end">
                <div class="flex-grow-1 text-body">Don't have an account? <a href="<?=APP_DOMAIN?>auth/register">Sign Up</a></div>
