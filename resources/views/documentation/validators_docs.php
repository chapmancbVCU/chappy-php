...
<div class="main">
    ...
    <table class="table table-striped  table-bordered table-hover w-75 mb-5 mx-auto table-sm">
        <tr>
            <td><a href="<?=APP_DOMAIN?>documentation/customValidator" class="link-primary w-25">Custom Validator</a></td>
        ...
        <tr>
            <td><a href="<?=APP_DOMAIN?>documentation/emailValidator" class="link-primary w-25">Email Validator</a></td>
            <td>Child class that performs validation for E-mail fields.</td>
        </tr>
        <tr>
            <td><a href="<?=APP_DOMAIN?>documentation/lowerCharValidator" class="link-primary w-25">Lower Char Validator</a></td>
            <td>Child class class that supports ability to check if field contains a lower case character in the field.</td>
        </tr>
        <tr>
            <td><a href="<?=APP_DOMAIN?>documentation/matchesValidator" class="link-primary w-25">Matches Validator</a></td>
            <td>Child class that performs validation for two fields that are required to have the same value.</td>
        </tr>
        <tr>
            <td><a href="<?=APP_DOMAIN?>documentation/maxValidator" class="link-primary w-25">Max Validator</a></td>
            <td>Child class that performs validation for the maximum length of a value for a field.</td>
        </tr>
        <tr>
            <td><a href="<?=APP_DOMAIN?>documentation/minValidator" class="link-primary w-25">Min Validator</a></td>
            <td>Child class that performs validation for the minimum length of a value for a field.</td>
        </tr>
        <tr>
            <td><a href="<?=APP_DOMAIN?>documentation/numberCharValidator" class="link-primary w-25">Number Char Validator</a></td>
            <td>Child class class that supports ability to check if field contains a numeric character in the field.</td>
        </tr>
        <tr>
            <td><a href="<?=APP_DOMAIN?>documentation/numericValidator" class="link-primary w-25">Numeric Validator</a></td>
            <td>Child class that performs validation for fields than only accept numeric values.</td>
        </tr>
        <tr>
            <td><a href="<?=APP_DOMAIN?>documentation/requiredValidator" class="link-primary w-25">Required Validator</a></td>
            <td>Child class that performs validation for fields that are required.</td>
        </tr>
        <tr>
            <td><a href="<?=APP_DOMAIN?>documentation/specialCharValidator" class="link-primary w-25">Special Char Validator</a></td>
        ...
        <tr>
            <td><a href="<?=APP_DOMAIN?>documentation/uniqueCharValidator" class="link-primary w-25">Unique Char Validator</a></td>
            <td>Child class that performs validation for fields that require a unique entry in a database.</td>
        </tr>
        <tr>
            <td><a href="<?=APP_DOMAIN?>documentation/upperCharValidator" class="link-primary w-25">Upper Char Validator</a></td>
