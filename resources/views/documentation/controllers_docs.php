...
<div class="main">
    ...
    <table class="table table-striped  table-bordered table-hover w-75 mx-auto mb-5 table-sm">
        ...
        <tr>
            <td><a href="<?=APP_DOMAIN?>documentation/homeController" class="link-primary w-25">Home Controller</a></td>
        ...
        <tr>
            <td><a href="<?=APP_DOMAIN?>documentation/restrictedController" class="link-primary w-25">Restricted Controller</a></td>
