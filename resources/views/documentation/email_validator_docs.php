<?php $this->setSiteTitle("EmailValidator - Custom MVC Framework Docs"); ?>
<?php $this->start('body'); ?>
...
<div class="main">
    ...
    <table class="table table-striped table-condensed table-bordered table-hover w-75 mx-auto table-sm mb-5">
        ...
        <tr>
            <td colspan="2">Implements the abstract function of the same name from the parent class.  Enforces requirement where a field must be a valid E-mail.</td>
        </tr>
        <tr>
